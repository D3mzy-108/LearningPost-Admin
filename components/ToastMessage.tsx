...
const ToastMessage: React.FC<ToastMessageProps> = ({
  ...
  return (
    ...
    <li
      className={`${colors} w-full max-w-sm ml-auto rounded-xl py-4 px-6 flex items-center gap-3 backdrop-blur-md ${transitionClasses} ${visibilityClasses} pointer-events-auto`}
    >
